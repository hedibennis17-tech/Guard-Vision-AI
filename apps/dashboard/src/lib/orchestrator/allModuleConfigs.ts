...
export const TRAFFIC_CONFIG: ModulePageConfig = {
  ...
  detections:[
    {id:"car",          cocoClass:"car",         label:"Voiture détectée",       icon:"🚗",color:"#8B5CF6",severity:"info",    alertOn:true, category:"vehicle",sendToEvents:true, sendToNotif:true, description:"Véhicule léger"},
    {id:"truck",        cocoClass:"truck",        label:"Camion détecté",          icon:"🚛",color:"#6D28D9",severity:"warning", alertOn:true, category:"vehicle",sendToEvents:true, sendToNotif:true, description:"Poids lourd"},
    {id:"bus",          cocoClass:"bus",          label:"Bus détecté",             icon:"🚌",color:"#4C1D95",severity:"info",    alertOn:true, category:"vehicle",sendToEvents:true, sendToNotif:false,description:"Transport commun"},
    {id:"motorcycle",   cocoClass:"motorcycle",   label:"Moto détectée",          icon:"🏍️",color:"#7C3AED",severity:"info",   alertOn:true, category:"vehicle",sendToEvents:true, sendToNotif:false,description:"Deux-roues"},
    {id:"bicycle",      cocoClass:"bicycle",      label:"Vélo détecté",           icon:"🚲",color:"#A78BFA",severity:"info",    alertOn:true, category:"vehicle",sendToEvents:true, sendToNotif:false,description:"Cycliste"},
    {id:"person",       cocoClass:"person",       label:"Piéton détecté",         icon:"🚶",color:"#0EA5E9",severity:"warning", alertOn:true, category:"human",  sendToEvents:true, sendToNotif:true, description:"Piéton sur route"},
    {id:"stop sign",    cocoClass:"stop sign",    label:"Panneau Stop",           icon:"🛑",color:"#EF4444",severity:"info",    alertOn:false,category:"object", sendToEvents:false,sendToNotif:false,description:"Signalisation"},
